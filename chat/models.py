...
class ChatSession(TrackableDateModel):
    ...
    owner = models.ForeignKey(User, related_name='chat_sessions', on_delete=models.PROTECT)
...
class ChatSessionMessage(TrackableDateModel):
    ...
    user = models.ForeignKey(User, related_name='chat_sessions_messages',on_delete=models.PROTECT)
...
class ChatSessionMember(TrackableDateModel):
    ...
    user = models.ForeignKey(User, related_name='chat_sessions_members', on_delete=models.PROTECT)
    chat_session = models.ForeignKey(
